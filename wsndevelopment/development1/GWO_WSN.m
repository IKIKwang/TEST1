...
for mm = 1 : 1
    ...
    wolf_one = zeros(dimension,N,1);
    wolf_one_dis = zeros(dimension,N,1);
    wolf_two = zeros(dimension,N,1);
    wolf_two_dis = zeros(dimension,N,1);
    wolf_three = zeros(dimension,N,1);
    wolf_three_dis = zeros(dimension,N,1);
...
for Exper_index = 1:Exper_num
    ...
    while iter <= ger
        ...
        factor = 1 - (iter/ger);
        A1 = 2 * factor * rand(dimension,N,sizepop) - factor;
        A2 = 2 * factor * rand(dimension,N,sizepop) - factor;
        A3 = 2 * factor * rand(dimension,N,sizepop) - factor;

        C1 = 2 * rand(dimension,N,1);
        C2 = 2 * rand(dimension,N,1);
        C3 = 2 * rand(dimension,N,1);
